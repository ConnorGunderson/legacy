...
def rr(btype, enh_l, stone, rate, total, rt=1, ir=rates, em=em):
    # stacks per level
    enh = {
        '+15': 1,
        'pri': 2,
...
def mean(em, ir, b_type):
    ...
    # Start of Stacks
    t['r15s'] = rr('rb', '+15', bs, 1, 0, 14)
    t['r24s'] = rr('rb', 'duo', 'cbs_a', 15, t['r15s'], 3)
    t['r28s'] = rr('rb', 'tri', 'cbs_a', 24, t['r24s'])
    t['r32s'] = rr('rb', 'tri', 'cbs_a', 28, t['r28s'])
    # t['r32s'] = rr('rb', 'tri', 'cbs_a', 24, t['r24s'])
    # t['r32s'] = rr('rb', 'tri', 'cbs_a', 24, t['r24s'])
